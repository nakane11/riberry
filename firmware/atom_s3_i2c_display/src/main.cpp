...
void setup() {
  ...
  // atoms3lcd.println("world");
  // LGFX lcd;
  // lcd.init();
  // lcd.println("hello world");

  PrimitiveLCD primitive_lcd;
  // // primitive_lcd.println("hoge");
  primitive_lcd.printColorText("bar");
  delay(1000);
  primitive_lcd.setRotation(1);
  delay(1000);
  primitive_lcd.clear();
  delay(1000);
  primitive_lcd.printColorText("fuga");

  // atoms3lcd.println("world");
  // atoms3lcd.printColorText("boo");
